  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #333;">Welcome to Hire4Drive Admin Panel</h2>
        <p>Hello ${userName},</p>
        <p>Your admin account has been created successfully! You can now access the admin panel to manage the platform.</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://admin.hire4drive.com/" 
  ...
  const mailOptions = {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="https://offlinepanel.hire4drive.com/" 
             style="background-color: #007bff; color: white; padding: 12px 30px; text-decoration: none; border-radius: 5px; display: inline-block; font-weight: bold;">
            Access Panel
          </a>
        </div>
