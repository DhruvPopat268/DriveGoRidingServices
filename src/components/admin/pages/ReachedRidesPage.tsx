...
export const ReachedRidesPage = ({ onNavigateToDetail, onNavigateToRiderDetail, onNavigateToDriverDetail }) => {
  ...
  const fetchRides = async () => {
    try {
      ...
      const response = await apiClient.get(`${import.meta.env.VITE_API_URL}/api/rides/reached?${params}`);
