...
export const BookedRidesPage = ({ onNavigateToDetail, onNavigateToRiderDetail, onNavigateToDriverDetail }: BookedRidesPageProps) => {
  ...
  const confirmDriverAssignment = async () => {
    ...
    try {
      await apiClient.post(`${import.meta.env.VITE_API_URL}/api/rides/admin/driver/confirm`, {
  ...
  return (
    <div className="space-y-6 bg-white text-black p-6 overflow-x-hidden">
      ...
      <Card className="bg-white border-gray-200">
        <CardHeader>
          <CardTitle className="text-black">Booked Rides ({totalRides})</CardTitle>
        </CardHeader>
        <div className="px-6">
          {/* Filter Section */}
          <RideFilters
